...
public abstract class FakeDatabase implements IDatabase { 	// temporarily abstract so the class no longer has an error - D.I.
...
//	
//	//not implemented in FakeDB
//		public List<ChessPiece> findPiecesByGame(final int game) {
